...
public class ImportIO {
	 ...
	 * functions on
	 */
	@Setter ExecutorService executorService = null;
	...
	/**
	 * Send a query to import.io to get the schema parameters of a connector 
	 * @param aGUID the connector for which we want the schema parameters
	 * @param type the type of parameters (input or output).
	 * 1 for input
	 * 2 for output
	 * @return the list of parameter names
	 * @throws Exception if GUID is null or if there's an error while requesting import.io
	 */
	public ArrayList<String> schemaRequest(String aGUID, int type)  throws Exception
	{
		return this.session.schemaRequest(aGUID, type);
	}
